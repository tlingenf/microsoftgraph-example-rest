...
namespace GraphTutorial
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Follow along with this turorial at: https://docs.microsoft.com/en-us/graph/tutorials/dotnet-core");
            Console.WriteLine("For this sample to work, you will need to create an app registration and add the dotnet user-secrets to your machine as outlined in the tutorial.");
            Console.WriteLine();
